...
> Ramble: "You already had nvim in your `.dotfiles` repo, why this one?", more often than not I just want to clone the nvim configs, and having everything in a single repo is a hassle.
...
> Note: Be careful if you already have a config, make a backup of your current config before cloning this one.
